        ...
        <div class="remote">
          ...
          >
            <div class="btn">
              ...
              >结束视频</el-button
              >
              <el-button type="primary"  @click="takePicture"
              >截图</el-button
              >
...
export default {
  ...
  methods: {
    ...
    signalingMessageCallback (message) {
      let otherId = message.from.userId // 对方id
      ...
      if(message.type === 'offer') {
        ...
        pc.setRemoteDescription(new RTCSessionDescription(message)).then(()=> {
          pc.createAnswer().then((description)=>{
            this.createdAnswerSuccess(pc,description)
